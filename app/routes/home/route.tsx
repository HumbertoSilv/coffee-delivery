  ...
  return (
    <div>
      <section className="py-12 px-4 relative">
        <h1 className="font-black text-3xl font-title">Encontre o café perfeito para qualquer hora do dia</h1>
        <span className="py-2 block text-base">Com o Coffee Delivery você recebe seu café onde estiver, a qualquer hora</span>
        ...
        <div className="text-sm pt-5">
          <div className="flex items-center gap-2 py-1">
            <ShoppingCart
              size={25}
              weight="fill"
              className="bg-amber-700 text-slate-50 rounded-full p-1"
            />
          ...
          <div className="flex items-center gap-2 py-1">
            <Package
              size={25}
              weight="fill"
              className="bg-zinc-500 text-slate-50 rounded-full p-1"
            />
          ...
          <div className="flex items-center gap-2 py-1">
            <Timer
              size={25}
              weight="fill"
              className="bg-yellow-500 text-slate-50 rounded-full p-1"
            />
          ...
          <div className="flex items-center gap-2 py-1">
            <Coffee
              size={25}
              weight="fill"
              className="bg-violet-700 text-slate-50 rounded-full p-1"
            />
            <span>O café chega fresquinho até você</span>
          </div>
        </div>
        <div className="absolute top-0 left-0 object-cover hidden md:block">
          <svg  width="1440" height="544" viewBox="0 0 1440 544" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_212_16580)" filter="url(#filter0_f_212_16580)">
              <path opacity="0.15" d="M1374.19 237.88C1407.7 274.97 1434.88 339.451 1384.8 384.973C1379.63 389.666 1331.18 432.248 1258.3 426.96C1169.54 420.52 1151.34 350.812 1053.38 332.716C947.298 313.119 885.037 379.425 833.231 359.056C771.971 334.97 764.451 205.071 875.331 149.396C1008.91 82.3255 1284.08 138.151 1374.19 237.88Z" fill="#EBC136"/>
              ...
              <path opacity="0.15" d="M246.937 136.892C259.507 158.616 271.932 200.056 259.695 237.492C258.433 241.351 246.5 276.558 224.055 281.502C196.717 287.524 186.675 241.405 155.792 240.442C122.347 239.4 107.765 292.665 90.7319 284.678C70.5904 275.234 59.883 186.175 89.8998 134.53C126.06 72.3152 213.139 78.4763 246.937 136.892Z" fill="#EBC136"/>
              ...
              <path opacity="0.15" d="M195.139 382.866C214.225 360.714 234.35 318.381 219.454 279.978C217.918 276.018 203.31 239.899 171.98 234.685C133.82 228.335 116.761 275.475 73.1632 276.25C25.9491 277.089 8.74424 222.467 -15.7709 230.526C-44.7595 240.056 -65.4579 331.145 -26.3915 384.214C20.6708 448.144 143.816 442.431 195.139 382.866Z" fill="#8047F8"/>
            </g>
            <defs>
      ...
      <section className="px-4">
        <h2 className="font-black text-xl font-title">Nossos cafés</h2>
